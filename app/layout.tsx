                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="md:col-span-2">
                      <div className="flex items-center space-x-3 mb-6">
                        ...
                        <div>
                          <h3 className="text-2xl font-playfair font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                            Techno Cars
                          </h3>
                          <p className="text-slate-400 text-sm">Premium Car Rentals</p>
                        </div>
                      </div>
                      <p className="text-slate-300 leading-relaxed mb-4">
                        Experience the future of car rental with our premium fleet and exceptional service. 
                        Your journey starts here.
                      </p>
                      <div className="flex space-x-4">
                        <a href="#" className="w-10 h-10 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center hover:bg-white/20 transition-all duration-300 hover:scale-110">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        <li><a href="/vehicles" className="text-slate-300 hover:text-white transition-colors">Browse Cars</a></li>
